...
# Configuration
MODEL_PATH = "./global_models/global_model_round_2.pth"  # Update to the correct path if necessary
...
if __name__ == "__main__":
    ...
    for pred, truth in zip(predictions[:10], ground_truths[:10]):  # Display first 10 samples
